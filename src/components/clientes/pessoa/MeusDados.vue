  ...
  >
        <v-card>
            <v-toolbar  class="elevation-0">
                ...
                <v-toolbar-items>
                    <v-btn color="primary" @click="AlterarEndereco(false)" text>Alterar Endereço</v-btn>
            ...
            <v-card flat>
                ...
                <v-form v-model="valid" lazy-validation ref="form">  
                    <v-card-text class="py-6">
                        <v-row class="my-3">
                            <v-col cols="12" sm="12" md="12" lg="12" style="display: flex; justify-content: center">
                                <center>
                                    <v-card height="250" min-width="300" max-width="300" class="mb-5" flat><center>
                                        <v-row>
                                            <v-col class="mx-2">
                                                <v-avatar color="grey lighten-2" v-bind="attrs = {boilerplate: true}"  size="150" class="mt-md-0 mt-lg-0" style="margin-top: 80px">
                        ...
                        <v-card-title class="py-12">
                            <v-icon color="primary" large left>mdi-account-circle</v-icon>
                            <span class="title font-weight-light">Informações</span>
                        </v-card-title>
                        ...
                        <v-col cols="12" sm="12" md="12" lg="12">
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="3" v-if="item.sexo">
            ...
            <v-dialog persistent v-model="dialogAlterarEndereco" width="600px">
                <v-card>
